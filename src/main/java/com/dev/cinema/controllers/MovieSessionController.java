...
public class MovieSessionController {
    ...
    public void addMovieSessions(@RequestBody MovieSessionRequestDto movieSessionRequestDto) {
        movieSessionService.add(transferDtoToMovieSession(movieSessionRequestDto));
    }
